...
const packageJsonPath = path.join(repoRoot, "lib/web-fetch-md/package.json");
const launchers = [
...
async function runCli(launcherPath, url) {
  const cliPath = path.join(repoRoot, launcherPath);
